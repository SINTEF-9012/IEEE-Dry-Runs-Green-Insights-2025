...
for metric in $metrics; do
    ...
    gnuplot <<EOF
        set terminal pngcairo size 1000,600 enhanced font 'Linux Libertine Bold,14'
        ...
        plot \
            'data/nhrf-base1.dat' using (\$1 - 0.3):${col} with boxes ls 1 fs pattern 1 title "base1", \
            'data/nhrf-base2.dat' using (\$1 + 0.0):${col} with boxes ls 2 fs pattern 2 title "base2", \
            'data/nhrf-optimized.dat' using (\$1 + 0.3):${col} with boxes ls 3 fs pattern 5 title "optimized"
